...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SigniFlowConnect.LogoutResponse();
  });
  ...
  describe('LogoutResponse', function() {
    it('should create an instance of LogoutResponse', function() {
      // uncomment below and update the code to test LogoutResponse
      //var instane = new SigniFlowConnect.LogoutResponse();
      //expect(instance).to.be.a(SigniFlowConnect.LogoutResponse);
    });
    ...
    it('should have the property resultField (base name: "ResultField")', function() {
      ...
      //var instance = new SigniFlowConnect.LogoutResponse();
