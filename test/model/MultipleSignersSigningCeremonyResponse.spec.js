...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SigniFlowConnect.MultipleSignersSigningCeremonyResponse();
  });
  ...
  describe('MultipleSignersSigningCeremonyResponse', function() {
    it('should create an instance of MultipleSignersSigningCeremonyResponse', function() {
      // uncomment below and update the code to test MultipleSignersSigningCeremonyResponse
      //var instane = new SigniFlowConnect.MultipleSignersSigningCeremonyResponse();
      //expect(instance).to.be.a(SigniFlowConnect.MultipleSignersSigningCeremonyResponse);
    });
    ...
    it('should have the property ceremonyIDField (base name: "CeremonyIDField")', function() {
      ...
      //var instance = new SigniFlowConnect.MultipleSignersSigningCeremonyResponse();
