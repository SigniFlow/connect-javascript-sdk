...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SigniFlowConnect.LoginResponse();
  });
  ...
  describe('LoginResponse', function() {
    it('should create an instance of LoginResponse', function() {
      ...
      //var instane = new SigniFlowConnect.LoginResponse();
      //expect(instance).to.be.a(SigniFlowConnect.LoginResponse);
    });
    ...
    it('should have the property resultField (base name: "ResultField")', function() {
      ...
      //var instance = new SigniFlowConnect.LoginResponse();
